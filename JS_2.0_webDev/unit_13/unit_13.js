...
function f13() {
    let o = document.querySelector('.out-13')
    let out = 0;
    for (let key in a13) {
...
function f14() {
    let o = document.querySelector('.out-14')
    let out = '';
    for (let key in a14) {
        out += a14[key][0] + ' '
    }
...
function f15() {
    let o = document.querySelector('.out-15')
    let out = '';
    for (let key in a15) {
...
function f16() {
    let o = document.querySelector('.out-16')
    let out = '';
    for (let key in a16) {
        out += a16[key]['name'] + ' '
    }
...
function f17() {
    let o = document.querySelector('.out-17')
    let out = ''
    for (let key in a17) {
        if (a17[key]['age'] > 30) {
            out += ` ${a17[key]['name']} `
...
function f18() {
    let o = document.querySelector('.out-18')
...
function f19() {
    ...
    let o = document.querySelector('.out-19')
    let input = document.querySelector('.i-19').value.toLowerCase()
    let out = ''

    for (let key in a19) {
        let branch = a19[key]
        for (let i = 0; i < branch.length; i++) {
            if (a19[key][i].toLowerCase() === input) {
                out += key
                break
            }
        }
...
function f20() {
    let o = document.querySelector('.out-20')
    let out = ''
