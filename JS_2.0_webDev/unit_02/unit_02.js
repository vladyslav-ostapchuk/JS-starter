...
function t9() {
    let data2 = document.querySelector('.i-9');
    let data3 = data2.value;
    document.querySelector('.out-9').textContent = data3;
    data2.value = '';
}
...
function t10() {
    ...
    let input_0 = input10.value * 20;
    document.querySelector('.out-10').textContent = input_0;
    input10.value = '';
}
...
function t11() {
    ...
    let input_111 = input11.value + 55;
    document.querySelector('.out-11').textContent = input_111;
    input11.value = '';
}
...
function t13() {
    let num1 = document.querySelector('.i-13-1').value;
    let num2 = document.querySelector('.i-13-2').value;
