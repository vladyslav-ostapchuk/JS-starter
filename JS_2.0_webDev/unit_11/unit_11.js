...
function f4() {
    let v = document.querySelector('.i-4').value
    d1.push(v)
    showArr('.out-4', d1);
}
...
function f6() {
    let v = document.querySelector('.i-6').value
    d6[d6.length] = v
    showArr('.out-6', d6);
}
...
function f8() {
    let v = document.querySelector('.i-8').value
    let arr = [];
    arr[0] = v;
...
function f11() {
    let v = +document.querySelector('.i-11').value
    let out = document.querySelector('.out-11')

    out.innerHTML = d11.indexOf(v)
...
// document.querySelector('.i-14').value = 5
// f14();
// console.log(d14)
