...
let ar1 = ['str', 3, 4, true, false, 'strrr', 3]// переменную обьявляем здесь!!!!
...
let ar2 = ['str', 3, 4, true, false, 'strrr', 3]// переменную обьявляем здесь!!!!
...
let ar3 = ['str', 3, 4, true, false, 'strrr', 3]  // переменную обьявляем здесь!!!!
...
function f5() {
    ...
    out.innerHTML = ar4[0] + ar4[2] + ar4[3]
...
function f8() {
    ...
    document.querySelector('.out-8').innerHTML = ou
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = elem
}
