...
document.querySelector('div.out-13').innerHTML = '<img src="https://itgid.info/img/js20/js20_unit_01.png" alt="js">'
...
document.querySelector('div.out-15').innerHTML = z1 / z2;
...
document.querySelector('div.out-18').innerHTML = 5;
console.log(out18)
...
document.querySelector('div.out-19').innerHTML = 'out-19-test';
console.log(out19)
