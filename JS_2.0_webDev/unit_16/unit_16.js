...
function f3() {
    let input = document.getElementsByClassName('out-3')
...
function f4() {
    let input = document.querySelectorAll('.out-4')
    for (let item of input) {
        item.innerHTML += 4
    }
}
...
function f6() {
    ...
    //     for (let v = 0; v < a6[i].length; v++) {
    //         ar.push(a6[i][v])
    //     }
    // }
    // console.log(ar)
    // document.querySelector('.out-6').innerHTML = ar.join(' ')
    let ar = []
    for (let item of a6) {
        for (let val of item) {
            ar.push(val)
...
function f9() {
    ...
    for (let i = 0; i < a9.length; i++) {
        if (a9[i].length > a9[index].length) {
            index = i
        }
    }
    return (a9[index].length - 1)
}
...
function f11() {
    let v = document.querySelector('.out-11')
    let out = ''
    for (let key in a11) {
        if (a11[key] > 10) {
            out += a11[key] + ' '
...
function f12() {
    let v = document.querySelector('.out-12')
    let out = ''
    for (let item of a12) {
        out += item + ' '
...
function f13() {
    let v = document.querySelector('.out-13')
    let out = ''
    for (let item of a13) {
        out += item + ' '
        console.log(item)
...
function f14() {
    let v = document.querySelector('.out-14')
    let out = ''
    for (let item of a14) {
        out += item + ' '
        console.log(item)
...
function f15() {
    let elem = document.querySelectorAll('.out-15')
