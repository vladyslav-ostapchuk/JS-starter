...
function f5() {
    let out = document.querySelector('.out-4')
    let t = out.classList.contains('bg-orange')
...
function f6() {
    let out = document.querySelectorAll('.p-6')
    document.querySelector('.out-6').innerHTML = out.length
}
...
function f8() {
    ...
    let i = 0
    while (i < 4) {
        out[i].classList.toggle('bg-orange')
        i++
    }
}
...
let out = document.querySelectorAll('.out-10');
...
function f18() {
    let c = document.querySelector('.p-18').getAttribute('data-b')
...
function f20() {
    let out = document.querySelector('.out-20').setAttribute('title', 'go')
