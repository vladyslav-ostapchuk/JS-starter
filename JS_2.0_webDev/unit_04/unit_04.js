...
function f5() {
    ...
    if (myCheckbox.checked) {
        out.textContent = myCheckbox.value
    } else {
        out.textContent = false
    }
}
...
function f6() {
    ...
    let out = document.querySelector('.out-6').textContent = input.value
...
function f7() {
    ...
    let out = document.querySelector('.out-71').textContent = input.value
...
function f8() {
    ...
    let out = document.querySelector('.out-8').innerHTML = `
...
function f10() {
    let c = document.querySelector('.i-10 ').value

    let out = document.querySelector('.out-10').style.background = c;
...
function f11() {
    let c = document.querySelector('.i-111 ').value

    let out = document.querySelector('.i-112').value = c;
}
...
function f12() {
    let c = document.querySelector('.i-12 ').value
    let out = document.querySelector('.out-12').textContent = c;
}
...
function f13() {
    let c = document.querySelector('.i-13 ').value
    let out = document.querySelector('.out-13').textContent = c;
}
...
function f14() {
    let c = document.querySelector('.t-14 ').value
    let out = document.querySelector('.out-14').textContent = c;
}
...
function f15() {
    ...
    document.querySelector('.t-15').textContent = c;
}
...
function f16() {
    ...
    let out10 = document.querySelector('.out-16');
    let val = sel.options[sel.selectedIndex].value;
    if (val == 'one') {
        out10.textContent = sel.value;
    } else if (val == 'two') {
        out10.textContent = sel.value;
    } else if (val == 'five') {
        out10.textContent = sel.value;
...
function f19() {
    ...
    document.querySelector('.i-19').value = out;
}
...
function f20() {
    let select = document.querySelector('.s-201');
    document.querySelector('.s-202').value = select.value;
