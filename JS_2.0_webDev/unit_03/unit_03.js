...
function f1() {
   ...
   let num = +input.value;
   document.querySelector('.out-1').textContent = Boolean(num == 4);
}
...
function f3() {
   ...
   if (a1 < b1) {
      return document.querySelector('.out-3').innerHTML = b1;
   } else if (a1 > b1) {
      document.querySelector('.out-3').innerHTML = a1;
   }
...
function f4() {
   ...
   if (year <= 2003) {
      return document.querySelector('.out-4').innerHTML = 1;
   } else {
...
function f5() {
   ...
   let num = +input.value;
   if (num > 0) {
      return document.querySelector('.out-5').innerHTML = 1;
   } else if (num < 0) {
...
function f6() {
   ...
   let num = +input.value;
   if (num % 2 == 0) {
      return document.querySelector('.out-6').innerHTML = 'even';
   } else {
...
function f7() {
   ...
   let num = a ** b;
   document.querySelector('.out-7').textContent = num;
}
...
function f8() {
   let input1 = document.querySelector('.s-8');
   let num = +input1.value;
   switch (num) {
      case 1:
         return document.querySelector('.out-8').innerHTML = 'one';
      case 2:
         return document.querySelector('.out-8').innerHTML = 'two';
      case 3:
         return document.querySelector('.out-8').innerHTML = 'three';
   }
}
...
function f9() {
   let input1 = document.querySelector('.i-9');
...
function f10() {
   ...
   let optionText = input10.options[input10.selectedIndex].text; // получаем текущее "текстовое содержимое" выбранного option.

   if (optionText == 'six') {
      out10.textContent = input10.value;
   } else if (optionText == 'seven') {
      out10.textContent = input10.value;
   } else if (optionText == 'eleven') {
      out10.textContent = input10.value;
   } else if (optionText == 'nine') {
      out10.textContent = input10.value;
   }
}
...
function f11() {
   let input = document.querySelector('.s-110');
   let out11 = document.querySelector('.out-11');

   let optionText = input.options[input.selectedIndex].text; // получаем текущее "текстовое содержимое" выбранного option.

   if (optionText == 'six') {
      out11.textContent = input.value;
   } else if (optionText == 'seven') {
      out11.textContent = input.value;
   } else if (optionText == 'eleven') {
      out11.textContent = input.value;
...
function f13() {
   let w = i120.value;
   document.querySelector('.out-13').innerHTML = (typeof w);
}
...
function f14() {
   ...
   let input = document.querySelector('.s-143');
   let a = +input1.value;
   let b = +input2.value;

   let optionText = input.options[input.selectedIndex].text;
...
function f15() {
   let option1 = +document.querySelector('.s-151').value;
   let option2 = +document.querySelector('.s-152').value;
   ...
   if (s3 === '||') {
      out.textContent = option1 || option2
   } else if (s3 === '&&') {
      out15.textContent = option1 && option2
   }
}
